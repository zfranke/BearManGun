...
async function welcome() {
  ...
  console.log(`
    ...
    and you will ${chalk.bgYellow('lose')}.
...
async function question2() {
  ...
  return handleAnswer(answers.question_1 === 'Bear');
}
...
async function question3() {
  ...
  return handleAnswer(answers.question_1 === 'Man');
}
